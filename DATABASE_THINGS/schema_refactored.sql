...
CREATE TABLE `learning_history` (
  ...
  KEY `idx_learning_decision_id` (`decision_id`),
  KEY `idx_learning_issue_action` (`issue_type`,`action_type`),
  CONSTRAINT `fk_learning_decision` FOREIGN KEY (`decision_id`) REFERENCES `decision_log` (`decision_id`) ON DELETE CASCADE
...
INSERT INTO `learning_history` VALUES (1,1,'DEADLOCK','ROLLBACK_TRANSACTION','RESOLVED',0.9000,0.9200,'2026-03-10 04:03:32'),(2,2,'CONNECTION_OVERLOAD','ROLLBACK_TRANSACTION','RESOLVED',0.8500,0.8700,'2026-03-10 04:04:59'),(4,3,'DEADLOCK','ROLLBACK_TRANSACTION','RESOLVED',0.9000,0.9200,'2026-03-20 05:32:36'),(5,4,'CONNECTION_OVERLOAD','ROLLBACK_TRANSACTION','RESOLVED',0.8500,0.8700,'2026-03-20 05:32:36'),(6,5,'DEADLOCK','ROLLBACK_TRANSACTION','RESOLVED',0.9000,0.9200,'2026-03-20 05:32:36'),(7,6,'CONNECTION_OVERLOAD','ROLLBACK_TRANSACTION','RESOLVED',0.8500,0.8700,'2026-03-20 05:32:36'),(8,7,'DEADLOCK','ROLLBACK_TRANSACTION','RESOLVED',0.9000,0.9200,'2026-03-20 05:32:36'),(15,8,'DEADLOCK','ROLLBACK_TRANSACTION','RESOLVED',0.8000,0.9500,'2026-03-20 05:33:21'),(16,9,'SLOW_QUERY','RETRY_OPERATION','RESOLVED',0.7000,0.8500,'2026-03-20 05:33:21'),(17,10,'CONNECTION_OVERLOAD','KILL_CONNECTION','RESOLVED',0.8500,0.9300,'2026-03-20 05:33:21'),(18,11,'TRANSACTION_FAILURE','RETRY_OPERATION','FAILED',0.7500,0.8000,'2026-03-20 05:33:21'),(19,12,'DEADLOCK','ROLLBACK_TRANSACTION','RESOLVED',0.8200,0.9600,'2026-03-20 05:33:21'),(20,13,'SLOW_QUERY','RETRY_OPERATION','FAILED',0.6500,0.7000,'2026-03-20 05:33:21'),(21,14,'CONNECTION_OVERLOAD','KILL_CONNECTION','RESOLVED',0.8800,0.9400,'2026-03-20 05:33:21'),(22,15,'TRANSACTION_FAILURE','RETRY_OPERATION','RESOLVED',0.7800,0.8500,'2026-03-20 05:33:21'),(23,16,'DEADLOCK','ROLLBACK_TRANSACTION','RESOLVED',0.9000,0.9700,'2026-03-20 05:33:21'),(24,17,'SLOW_QUERY','RETRY_OPERATION','RESOLVED',0.7200,0.8800,'2026-03-20 05:33:21'),(25,18,'SLOW_QUERY','RETRY_OPERATION','RESOLVED',0.7000,0.7200,'2026-03-20 05:38:51'),(26,19,'TRANSACTION_FAILURE','RETRY_OPERATION','RESOLVED',0.7000,0.7200,'2026-03-20 05:38:51'),(27,20,'SLOW_QUERY','KILL_CONNECTION','RESOLVED',0.7000,0.7200,'2026-03-20 05:38:51'),(28,21,'DEADLOCK','ROLLBACK_TRANSACTION','RESOLVED',0.9500,0.9700,'2026-03-20 05:42:03'),(29,22,'DEADLOCK','ROLLBACK_TRANSACTION','RESOLVED',0.9000,0.9200,'2026-03-20 05:42:28'),(30,23,'DEADLOCK','ROLLBACK_TRANSACTION','RESOLVED',0.9000,0.9200,'2026-03-20 05:56:35'),(31,24,'DEADLOCK','ROLLBACK_TRANSACTION','RESOLVED',0.9000,0.9200,'2026-03-20 05:57:37'),(32,25,'CONNECTION_OVERLOAD','ROLLBACK_TRANSACTION','RESOLVED',0.8500,0.8700,'2026-03-20 05:57:46'),(33,26,'CONNECTION_OVERLOAD','ROLLBACK_TRANSACTION','RESOLVED',0.8500,0.8700,'2026-03-22 06:51:59');
