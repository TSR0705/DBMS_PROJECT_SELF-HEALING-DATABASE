  ...
  return (
    <div className="p-8 space-y-8">
      ...
      <div className="bg-white/80 backdrop-blur-sm border border-white/20 p-6 rounded-xl shadow-lg">
        <h2 className="text-xl font-semibold text-slate-900">Glassmorphism Test</h2>
        <p className="text-slate-600">This should have a glass-like effect with backdrop blur.</p>
      </div>
      ...
      <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300 cursor-pointer">
        <h2 className="text-xl font-semibold text-slate-900">Hover Effect Test</h2>
        <p className="text-slate-600">This should lift up and get more shadow on hover.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[1, 2, 3].map((i) => (
          <div key={i} className="bg-white/90 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-white/20">
            <h3 className="text-lg font-semibold text-slate-900 mb-2">Card {i}</h3>
            <p className="text-slate-600">Modern card with glassmorphism effect.</p>
          </div>
        ))}
      </div>
    </div>
