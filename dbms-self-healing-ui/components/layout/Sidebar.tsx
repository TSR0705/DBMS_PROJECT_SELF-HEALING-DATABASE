...
// Professional, technical sidebar design with real data
export function Sidebar() {
  ...
  const systemStatus = data
    ? {
        ...
        activeIssues: data.systemMetrics.totalIssues,
        isHealthy: data.systemMetrics.isConnected,
      }
    : {
        uptime: '0%',
        activeIssues: 0,
        ...
        <div className="bg-slate-50 rounded p-3">
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center space-x-2">
              <div
                className={`w-2 h-2 rounded-full ${systemStatus.isHealthy ? 'bg-green-500 animate-pulse' : 'bg-red-500'}`}
              ></div>
          ...
          <div className="grid grid-cols-2 gap-2 text-xs">
            ...
            <div>
              ...
              <div className="font-mono text-slate-900">
                {systemStatus.activeIssues} active
              </div>
            </div>
          </div>
        </div>
